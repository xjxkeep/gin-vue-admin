...
<template>
  ...
  <el-input v-model="searchInfo.device_id" placeholder="搜索条件" />
</el-form-item>
            
            <el-form-item label="设备通信id" prop="subscribe_id">
  <el-input v-model="searchInfo.subscribe_id" placeholder="搜索条件" />
</el-form-item>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="system_Device" />
            <ExportExcel  template-id="system_Device" filterDeleted/>
            <ImportExcel  template-id="system_Device" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="设备通信id" prop="subscribe_id" width="120" />

            <el-table-column align="left" label="设备token" prop="token" width="120" />

            <el-table-column align="left" label="注册地ip" prop="register_ip" width="120" />

            <el-table-column align="left" label="软件版本号" prop="version" width="120" />

            <el-table-column align="left" label="硬件序列号" prop="mac" width="120" />

        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            <template #default="scope">
            <el-button  type="primary" link class="table-button" @click="getDetails(scope.row)"><el-icon style="margin-right: 5px"><InfoFilled /></el-icon>查看</el-button>
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateDeviceFunc(scope.row)">编辑</el-button>
    ...
    {{ detailForm.device_id }}
</el-descriptions-item>
                    <el-descriptions-item label="设备通信id">
    {{ detailForm.subscribe_id }}
</el-descriptions-item>
                    <el-descriptions-item label="设备token">
    {{ detailForm.token }}
</el-descriptions-item>
                    <el-descriptions-item label="注册地ip">
    {{ detailForm.register_ip }}
</el-descriptions-item>
                    <el-descriptions-item label="软件版本号">
    {{ detailForm.version }}
</el-descriptions-item>
